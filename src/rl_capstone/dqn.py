...
class DQNAgent:
    ...
    Args:
        state_size (int): Size of the input domain 
            (6 features: lines, holes, bumpiness, heights, swap, queue (which will be current piece)
    ...
    def __init__(self, state_size=6, mem_size=10000, discount=0.95,
                 epsilon=1, epsilon_min=0.05, epsilon_stop_episode=500,
    ...
    def train(self, batch_size=32, epochs=3):
        ...
        if n >= self.replay_start_size and n >= batch_size:
            ...
            try:
                ...
                print(f'FAILED, couldn\'t convert to np array')
                # print(f'{len(x)}')
                # print(f'y = \n-----')
                # print(f'{len(y)}')
