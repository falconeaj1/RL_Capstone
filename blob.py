...
class BlobEnv:
    ...
    def reset(self, human = False):
        ...
        observation = [self.player.x - self.food.x, self.player.y - self.food.y,
                       self.player.x - self.enemy.x, self.player.y - self.enemy.y]
        return observation
    ...
    def step(self, action):
        ...
        new_observation = [self.player.x - self.food.x, self.player.y - self.food.y,
                           self.player.x - self.enemy.x, self.player.y - self.enemy.y]
